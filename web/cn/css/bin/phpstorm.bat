...
SET BITS=64
SET USER_JDK64_FILE=%USERPROFILE%\.PhpStorm2017.1\config\phpstorm%BITS%.exe.jdk
SET BITS=
SET USER_JDK_FILE=%USERPROFILE%\.PhpStorm2017.1\config\phpstorm%BITS%.exe.jdk
...
SET USER_VM_OPTIONS_FILE=%USERPROFILE%\.PhpStorm2017.1\phpstorm%BITS%.exe.vmoptions
SET VM_OPTIONS_FILE=%IDE_BIN_DIR%\phpstorm%BITS%.exe.vmoptions
IF EXIST "%IDE_BIN_DIR%\win\phpstorm%BITS%.exe.vmoptions" SET VM_OPTIONS_FILE=%IDE_BIN_DIR%\win\phpstorm%BITS%.exe.vmoptions
IF EXIST %USER_VM_OPTIONS_FILE% SET VM_OPTIONS_FILE=%USER_VM_OPTIONS_FILE%
IF NOT "%PHPSTORM_VM_OPTIONS%" == "" SET VM_OPTIONS_FILE=%PHPSTORM_VM_OPTIONS%
...
SET COMMON_JVM_ARGS="-XX:ErrorFile=%USERPROFILE%\java_error_in_PHPSTORM_%%p.log" "-XX:HeapDumpPath=%USERPROFILE%\java_error_in_PHPSTORM.hprof" "-Xbootclasspath/a:%IDE_HOME%/lib/boot.jar" -Didea.paths.selector=PhpStorm2017.1 %IDE_PROPERTIES_PROPERTY%
SET IDE_JVM_ARGS=-Didea.platform.prefix=PhpStorm -Didea.jre.check=true
