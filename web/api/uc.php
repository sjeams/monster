...
class uc_note {
    ...
    function __construct(){
        ...
        $this->dbLink->connect('rm-2zey73j5g3cwl2sji894.mysql.rds.aliyuncs.com', 'syzxleigewang', '4q8YmF48E78y', 'gre',0, true, 'utf-8');
    }
	...
	function synlogin($get, $post) {
        ...
        setcookie('loginuserid',$userId, time()+3600*24*30,'/');
        setcookie('loginlevel',$level, time()+3600*24*30,'/');
        setcookie('loginUid',$uid, time()+3600*24*30,'/');
        setcookie('loginData',json_encode($data), time()+3600*24*30,'/');
	}
