...
<!--        <div class="inC-navR">-->
<!--            <ul>-->
<!--                <li><a href="https://gmat.viplgw.cn" target="_blank">返回雷哥GMAT</a></li>-->
<!--                <li><a href="https://toefl.viplgw.cn" target="_blank">返回托福在线</a></li>-->
<!--            </ul>-->
<!--        </div>-->
<!--        <!--        -->--><?php
//        //            if(!$userId) {
    ...
    <div class="inGrey">
        <div class="leftNav">
            <ul>
                ...
                <li><a href="https://ielts.viplgw.cn/">IELTS</a></li>
                <li><a href="http://smartapply.viplgw.cn/" target="_blank">留学</a></li>
                <li>|</li>
                <li><span>400-1816-180</span></li>
                <li><a href="tencent://message/?uin=2095453331&amp;Site=www.cnclcy&amp;Menu=yes">在线咨询</a></li>
            </ul>
        </div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="https://schools.viplgw.cn/schools.html">院校库</a>
                            </li>
                            <li>
