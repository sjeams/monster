...
<head>
    ...
    <link rel="stylesheet" href="/cn/css/public.css?v=1.1.2"/>
...
<div class="blueNav">
    <div class="inBlue">
        ...
        <b>SmartApply公开课</b>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="https://gmat.viplgw.cn/" target="_blank">返回雷哥GMAT在线 |</a>
        <a href="https://toefl.viplgw.cn/" target="_blank">返回托福在线 |</a>
        <a href="/">返回商城</a>
        <p>400-1816-180</p>
    </div>
</div>
    ...
    if(!$userId) {
        ...
        <div class="huiy_login_c">
            ...
            <form class="ordinary">
                ...
                <div class="log_reg">
                    <input type="button" onclick="subLogin()" value="马上登录" />
                    <input type="button" onclick="location.href='/register.html'" value="立即注册" class="he_nav_register"/>
                </div>
            </form>
            <div class="qita_log">
                <span>其他账号登录<img src="/cn/images/index_hy_add.png" alt="" style="position: relative;top: 2px"/></span>
                <ul>
        ...
        <div class="foot-right">
            <div class="footNav">
                <ul>
                    ...
                    <li><span>|</span></li>
                    <li>
                        <a href="https://gmat.viplgw.cn/index.html" target="_blank">雷哥GMAT在线 </a>
                    </li>
                    <li><span>|</span></li>
                    <li> <a href="https://toefl.viplgw.cn" target="_blank">托福在线</a></li>
                    <li><span>|</span></li>
