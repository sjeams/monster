            ...
            <div class="clearfix tool_handle">
                ...
                <div class="tm fr tool_list clearfix">
                    <div class="tool_div" style="width:102px;">
                        <a href="/cn/mock-exam/rest?sectionId=<?php echo $sectionId;?>&minute=<?php echo $minute;?>" class="b-w continue">
            ...
            <div class="subMain">
                <div class="dx_wrap">
                    <div class="exit_hint" style="padding-bottom: 250px;">
                        You have finished this section and now will begin the next one. <br>
                        Select <b>Continue</b> to proceed.
                    </div>
                </div>
            </div>
        </div>
