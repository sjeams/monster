            ...
            <div class="centerRight fr bg_f">
                ...
                <div class="collection_wrap">
                        <div class="tagRow_content">
                            <div class="tagRow clearfix">
                                ...
                                <div class="tagList">
                                    <a href="/user/se-0/so-0/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                                       <?php if (empty($_GET['sectionId'])){ ?>class="on" <?php } ?>>全部</a>
                                    <a href="/user/se-1/so-0/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                                       <?php if (isset($_GET['sectionId']) && $_GET['sectionId'] == 1){ ?>class="on" <?php } ?>>填空</a>
                                    <a href="/user/se-2/so-0/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                                       <?php if (isset($_GET['sectionId']) && $_GET['sectionId'] == 2){ ?>class="on" <?php } ?>>阅读</a>
                                    <a href="/user/se-3/so-0/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                            ...
                            <div class="tagRow clearfix">
                                ...
                                <div class="tagList">
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-0/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                                       <?php if (empty($_GET['sourceId'])){ ?>class="on" <?php } ?>>全部</a>
                                    <?php
                                    foreach ($sources as $v) {
                                        ?>
                                        <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo $v['id'] ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                            ...
                            <div class="tagRow clearfix">
                                ...
                                <div class="tagList">
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-0/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                                       <?php if (empty($_GET['levelId'])){ ?>class="on" <?php } ?>>全部</a>
                                    <?php
                                    foreach ($levels as $v) {
                                        ?>
                                        <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo $v['id'] ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                            ...
                            <div class="tagRow clearfix">
                                ...
                                <div class="tagList">
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-0/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                                       <?php if (empty($_GET['state'])){ ?>class="on" <?php } ?>>全部</a>
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-1/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                                       <?php if (isset($_GET['state']) && $_GET['state'] == 1){ ?>class="on" <?php } ?>>正确</a>
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-2/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html"
                            ...
                            <div class="tagRow clearfix">
                                ...
                                <div class="tagList">
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-0.html"
                                       <?php if (empty($_GET['time'])){ ?>class="on" <?php } ?>>全部</a>
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-day.html"
                                       <?php if (isset($_GET['time']) && $_GET['time'] == 'day'){ ?>class="on" <?php } ?>>今日</a>
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-week.html"
                                       <?php if (isset($_GET['time']) && $_GET['time'] == 'week'){ ?>class="on" <?php } ?>>一周</a>
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-month.html"
                                       <?php if (isset($_GET['time']) && $_GET['time'] == 'month'){ ?>class="on" <?php } ?>
                                    ">一个月</a>
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-month1.html"
                                       <?php if (isset($_GET['time']) && $_GET['time'] == 'month1'){ ?>class="on" <?php } ?>>三个月</a>
                                    <a href="/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-month2.html"
                                    ...
                                    <dt class="flex-container">
                                        <div class="collection_text">
                                            ...
                                            <div class="testOver_data">
                                                <span>我的答案：<strong <?php if($v['correct']!=1){?>class="str_pink"<?php }else{ ?>class="str_pink answer_right"<?php } ?>><?php echo $v['answer'] ?></strong></span>
                                                <span>正确答案：<strong class="str_green"><?php echo $v['qanswer'] ?></strong></span>
                ...
                <script>
                        ...
                        $(document).on('click', '.iPage', function () {
                            ...
                            location.href = "/user/se-<?php echo isset($_GET['sectionId']) ? $_GET['sectionId'] : 0 ?>/so-<?php echo isset($_GET['sourceId']) ? $_GET['sourceId'] : 0 ?>/l-<?php echo isset($_GET['levelId']) ? $_GET['levelId'] : 0 ?>/st-<?php echo isset($_GET['state']) ? $_GET['state'] : 0 ?>/t-<?php echo isset($_GET['time']) ? $_GET['time'] : 0 ?>.html?page=" + page;
                        });
