...
<head>
    ...
    <meta name="description"
          content="雷哥GRE在线练习题库提供GRE历年真题练习、题目解析、题目讨论，包含verbal语文和quant数学单项练习、考点练习、错题练习，做题练习报告与数据分析，让你高效备考">
    <!--[if lt IE 9]>
...
<section id="gre_details">
    <div class="w1050">
        ...
        <div class="toolbar">
            <div class="clearfix tool_handle">
                ...
                <div class="tm fr tool_list clearfix">
                    <div class="tool_div" onclick="wrongTopic(this)"><span class="tool_name" style="line-height: 40px;">纠错</span>
                    </div>
                    ...
                    <div class="tool_div nextQuestion" onclick="nextQuestion();">
        ...
        <div class="topic_content bg_f">
            <div class="subMain">
                ...
                <div class="read_tit">
                    <?php
                    if ($questionData['readArticle']) {
                        ?>
                        <div class="dx_topic"><?php echo $questionData['readArticle'] ?></div>
                        <?php
                    }
                    ?>
                </div>
    ...
    <input type="hidden" id="topicType" data-int="false" value="1"><!--    题型-->
