...
<section id="gre_details">
        ...
        <div class="toolbar">
            <div class="clearfix tool_handle">
                ...
                <div class="tm fr tool_list clearfix">
                    ...
                    <div id="ExamQuit" onclick="examQuit();" class="tool_div"><span class="tool_name">Quit<br>w/Save</span></div>
            ...
            <div class="clearfix">
                ...
                <h1 class="cur_tit fr">Question <?php echo (isset($result['doNum'])?$result['doNum']:0)+1 ?> of <?php echo $result['totalNum'] ?></h1>
            </div>
        </div>
        <!--内容-->
                        ...
                        if($questionData['optionA']) {
                            foreach ($questionData['optionA'] as $k => $v) {
                                ...
                                <label class="label_row" for="check<?php echo $k + 1 ?>">
                                    <input type="checkbox" onclick="checkbox(this)" name="answer" class="input_check"
    ...
    <input type="hidden" id="topicType" data-int="false" value="3"><!--    题型-->
