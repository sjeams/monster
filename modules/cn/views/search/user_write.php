...
<div class="clearfix">
    <div class="w12" style="width: 1200px;margin: auto;padding: 30px 0;">
        <div class="span10" id="datacontent">
            <form action="/cn/search/user-write" method="post" class="form-horizontal" id="addForm">
                <fieldset>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <input type="hidden" name="queId" value="<?php echo isset($_GET['questionId'])?$_GET['questionId']:'/' ?>">
