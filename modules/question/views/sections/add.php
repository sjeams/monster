...
<div class="span10" id="datacontent">
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo baseUrl?>/question/sections/index">试题管理</a> <span class="divider">/</span></li>
        <li class="active">添加单项分类</li>
    </ul>
    <form action="/question/sections/add" method="post" class="form-horizontal" id="addForm">
        <fieldset>
            <div class="control-group">
                <label for="modulename" class="control-label">单项分类名</label>
                <div class="controls">
                    <input type="text" id="sectionName" name="data[name]" value="" datatype="userName" needle="needle" msg="" style="width: 700px;">
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
