...
<div class="span10" id="datacontent">
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo baseUrl?>/question/levels/index">难度分类管理</a> <span class="divider">/</span></li>
        <li class="active">修改难度分类</li>
    </ul>
    <form action="/question/levels/update" method="post" class="form-horizontal" id="addForm">
        <fieldset>
            <div class="control-group">
                <label for="modulename" class="control-label">难度分类名</label>
                <div class="controls">
                    <input type="text" id="levelName" name="data[name]" value="<?php echo $data['name']?>" datatype="userName" needle="needle" msg="" style="width: 700px;">
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
