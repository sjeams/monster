...
<div class="span10" id="datacontent">
    <ul class="breadcrumb">
        ...
        <li class="active">添加来源</li>
    </ul>
    <form action="/question/source/add" method="post" class="form-horizontal" id="addForm">
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="sourceName" name="data[name]" value="" datatype="userName" needle="needle" msg="" style="width: 700px;">
                </div>
            </div>
            <div class="control-group">
                <label for="modulename" class="control-label">来源别名</label>
                <div class="controls">
                    <input type="text" id="alias" name="data[alias]" value="" datatype="userName" needle="needle" msg="" style="width: 700px;">
                </div>
            </div>
            <div class="control-group">
                <label for="modulename" class="control-label">来源排序</label>
                <div class="controls">
                    <input type="text" id="sort" name="data[sort]" value="" style="width: 700px;">
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
