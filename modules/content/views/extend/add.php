            ...
            <?php if(!isset($type)) { ?>
                <div class="control-group">
                    ...
                    <div class="controls" id="show">
                        <select name="extend[show]">
                            <option value="1" <?php if(isset($data) && $data['show'] ==1) echo 'selected'?>>显示</option>
                            <option value="0" <?php if(isset($data) && $data['show'] ==0) echo 'selected'?>>隐藏</option>
                        </select>
                    </div>
                </div>
                <?php
