...
<div class="span10" id="datacontent">
    <ul class="breadcrumb">
        ...
        <li><a href="/content/jump/index">GRE设置活动推荐</a> <span class="divider">/</span></li>
    </ul>
    <form action="/content/jump/add" method="post" class="form-horizontal">
        ...
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea name="content[noticeId]" style="width: 400px;height: 120px;" ><?php echo isset($data['noticeId'])?$data['noticeId']:''?></textarea>
