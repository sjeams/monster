...
cc.Class({
  ...
  onLoad: function onLoad() {
    ...
    this._urls = [{
      ...
      url: 'http://www.monster.com/app/api/file-content?url=http://www.monster.com/app/loading/loading.jpg',
      type: 'jpg'
    ...
    {
      url: 'http://www.monster.com/app/api/file-content?url=http://127.0.0.1/jq22honey.zip',
      type: 'zip'
